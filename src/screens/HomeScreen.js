    ...
    return (
        <>
                                    ...
                                    <div className='card-body px-4 py-5 px-md-5'>
                                        <div
                                            ...
                                            <svg xmlns='http://www.w3.org/2000/svg' width='1em' height='1em'
                                                ...
                                                <path
                                                    d='M7.066 6.76A1.665 1.665 0 0 0 4 7.668a1.667 1.667 0 0 0 2.561 1.406c-.131.389-.375.804-.777 1.22a.417.417 0 0 0 .6.58c1.486-1.54 1.293-3.214.682-4.112zm4 0A1.665 1.665 0 0 0 8 7.668a1.667 1.667 0 0 0 2.561 1.406c-.131.389-.375.804-.777 1.22a.417.417 0 0 0 .6.58c1.486-1.54 1.293-3.214.682-4.112z'></path>
                                            </svg>
                                        </div>
                                        <h5 className='fw-bold card-title'>Lorem ipsum dolor sit&nbsp;</h5>
                                        <p className='text-muted card-text mb-4'>Erat netus est hendrerit, nullam et
                            ...
                            <div className='col mb-4'>
                                <div className='card bg-primary-light'>
                                    <div className='card-body text-center px-4 py-5 px-md-5'>
                                        ...
                                        <h5 className='fw-bold card-title mb-3'>Lorem ipsum dolor sit&nbsp;nullam et
                    ...
                    <div className='row row-cols-1 row-cols-sm-2 row-cols-lg-3 d-sm-flex justify-content-sm-center'>
                        <div className='col mb-4'>
                            <div className='d-flex flex-column align-items-center align-items-sm-start'>
                                <p className='bg-dark border rounded border-dark p-4'>Nisi sit justo faucibus nec ornare
            ...
            <section className='py-5'>
                <div className='container'>
                    <div
                        className='bg-dark border rounded border-dark d-flex flex-column justify-content-between align-items-center flex-lg-row p-4 p-lg-5'>
                        ...
                        <form className='d-flex justify-content-center flex-wrap flex-lg-nowrap' method='post'>
                            <div className='my-2'>
                                <input className='border rounded-pill shadow-sm form-control' type='email' name='email'
