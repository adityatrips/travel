            ...
            <div className='col-12 col-lg-10 mx-auto'>
              <div className='position-relative' style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'flex-end' }}>
                <div style={{ position: 'relative', flex: '0 0 45%', transform: 'translate3d(-15%, 35%, 0)' }}>
                  <img className='img-fluid' data-bss-parallax='' data-bss-parallax-speed='0.8' src='/assets/img/products/3.jpg' />
                </div>
                <div style={{ position: 'relative', flex: '0 0 45%', transform: 'translate3d(-5%, 20%, 0)' }}>
                  <img className='img-fluid' data-bss-parallax='' data-bss-parallax-speed='0.4' src='/assets/img/products/2.jpg' />
                </div>
                <div style={{ position: 'relative', flex: '0 0 60%', transform: 'translate3d(0, 0%, 0)' }}>
                  <img className='img-fluid' data-bss-parallax='' data-bss-parallax-speed='0.25' src='/assets/img/products/1.jpg' />
                </div>
              </div>
            </div>
          </div>
            ...
            <div className='row row-cols-1 row-cols-md-2 mx-auto' style={{ maxWidth: 900 }}>
                ...
                <div className='card shadow-sm'>
                  <div className='card-body px-4 py-5 px-md-5'>
                    <div className='bs-icon-lg d-flex justify-content-center align-items-center mb-3 bs-icon' style={{ top: '1rem', right: '1rem', position: 'absolute' }}>
                      <svg xmlns='http://www.w3.org/2000/svg' width='1em' height='1em' fill='currentColor' viewBox='0 0 16 16' className='bi bi-bell text-success'>
              ...
              <div className='col mb-5'>
                <div className='card shadow-sm'>
                  <div className='card-body px-4 py-5 px-md-5'>
                    <div className='bs-icon-lg d-flex justify-content-center align-items-center mb-3 bs-icon' style={{ top: '1rem', right: '1rem', position: 'absolute' }}>
                      <svg xmlns='http://www.w3.org/2000/svg' width='1em' height='1em' fill='currentColor' viewBox='0 0 16 16' className='bi bi-bezier text-success'>
              ...
              <div className='col mb-4'>
                <div className='card shadow-sm'>
                  <div className='card-body px-4 py-5 px-md-5'>
                    <div className='bs-icon-lg d-flex justify-content-center align-items-center mb-3 bs-icon' style={{ top: '1rem', right: '1rem', position: 'absolute' }}>
                      <svg xmlns='http://www.w3.org/2000/svg' width='1em' height='1em' fill='currentColor' viewBox='0 0 16 16' className='bi bi-pin-angle text-success'>
              ...
              <div className='col mb-4'>
                <div className='card shadow-sm'>
                  <div className='card-body px-4 py-5 px-md-5'>
                    <div className='bs-icon-lg d-flex justify-content-center align-items-center mb-3 bs-icon' style={{ top: '1rem', right: '1rem', position: 'absolute' }}>
                      <svg xmlns='http://www.w3.org/2000/svg' width='1em' height='1em' fill='currentColor' viewBox='0 0 16 16' className='bi bi-chat-quote text-success'>
          ...
          <div className='row row-cols-1 row-cols-sm-2 row-cols-lg-3 d-sm-flex justify-content-sm-center'>
            <div className='col mb-4'>
              <div className='d-flex flex-column align-items-center align-items-sm-start'>
                ...
                <div className='d-flex'>
                  <img className='rounded-circle flex-shrink-0 me-3 fit-cover' width='50' height='50' src='/assets/img/team/avatar2.jpg' />
                  <div>
            ...
            <div className='col mb-4'>
              <div className='d-flex flex-column align-items-center align-items-sm-start'>
                <p className='bg-dark border rounded border-dark p-4'>Nisi sit justo faucibus nec ornare amet, tortor torquent. Blandit class dapibus, aliquet morbi.</p>
                <div className='d-flex'>
                  <img className='rounded-circle flex-shrink-0 me-3 fit-cover' width='50' height='50' src='/assets/img/team/avatar4.jpg' />
                  <div>
                    <p className='fw-bold text-primary mb-0'>John Smith</p>
                    <p className='text-muted mb-0'>Erat netus</p>
                  </div>
            ...
            <div className='col mb-4'>
              <div className='d-flex flex-column align-items-center align-items-sm-start'>
                <p className='bg-dark border rounded border-dark p-4'>Nisi sit justo faucibus nec ornare amet, tortor torquent. Blandit class dapibus, aliquet morbi.</p>
                <div className='d-flex'>
                  <img className='rounded-circle flex-shrink-0 me-3 fit-cover' width='50' height='50' src='/assets/img/team/avatar5.jpg' />
                  <div>
                    <p className='fw-bold text-primary mb-0'>John Smith</p>
                    <p className='text-muted mb-0'>Erat netus</p>
                  </div>
