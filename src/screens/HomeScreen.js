                ...
                <div className='row pt-5'>
                    <div className='col-md-8 col-xl-6 text-center text-md-start mx-auto'>
                        <div className='text-center'>
                            <h1 className='fw-bold primary-fg'>The best solution for you and your customers</h1>
                        </div>
                    </div>
                    <div className='col-12 col-lg-10 mx-auto'>
                        <div className='position-relative'
                            ...
                            <div style={{
                                position: 'relative', flex: '0 0 45%', transform: 'translate3d(-15%, 35%, 0)'
                            }}>
                                <img className='img-fluid' data-bss-parallax='' data-bss-parallax-speed='0.8'
                                     src='/assets/img/products/3.jpg'/>
                            </div>
                            <div style={{
                                position: 'relative', flex: '0 0 45%', transform: 'translate3d(-5%, 20%, 0)'
                            }}>
                                <img className='img-fluid' data-bss-parallax='' data-bss-parallax-speed='0.4'
                                     src='/assets/img/products/2.jpg'/>
                            </div>
                            <div
                                style={{position: 'relative', flex: '0 0 60%', transform: 'translate3d(0, 0%, 0)'}}>
                                <img className='img-fluid' data-bss-parallax='' data-bss-parallax-speed='0.25'
            ...
            <div className='container bg-white py-5'>
                <div className='row'>
                    <div className='col-md-8 col-xl-6 text-center mx-auto'>
                        <p className='fw-bold secondary-fg mb-2 '>Our Services</p>
                        <h3 className='primary-fg fw-bold'>What we can do for you</h3>
                    </div>
                </div>
                        ...
                        <div className='col mb-5'>
                            <div className='card -sm'>
                                <div className='card-body px-4 py-5 px-md-5'>
                                    ...
                                    <h5 className='primary-fg fw-bold card-title'>Lorem ipsum dolor sit&nbsp;</h5>
                                    <p className='text-muted card-text mb-4'>Erat netus est hendrerit, nullam et
                                        quis ad cras porttitor iaculis. Bibendum vulputate cras aenean.</p>
                                    <button className='btn buttons ' type='button'>
                                        Learn more
                                    </button>
                                </div>
                            </div>
                        ...
                        <div className='col mb-4'>
                            <div className='card bg-primary-light'>
                                <div className='card-body text-center px-4 py-5 px-md-5'>
                                    <p className='fw-bold secondary-fg card-text mb-2'>Fully Managed</p>
                                    <h5 className='fw-bold primary-fg card-title mb-3'>Lorem ipsum dolor
                                        sit&nbsp;nullam et
                ...
                <div className='row row-cols-1 row-cols-sm-2 row-cols-lg-3 d-sm-flex justify-content-sm-center'>
                    <div className='col mb-4'>
                        <div className='d-flex flex-column align-items-center align-items-sm-start'>
                            <p className='bg-white border rounded border-light p-4'>Nisi sit justo faucibus
                                nec ornare
                                amet, tortor torquent. Blandit class dapibus, aliquet morbi.</p>
                            <div className='d-flex'>
                                <img className='rounded-circle flex-shrink-0 me-3 fit-cover' width='50' height='50'
                                     src='/assets/img/team/avatar2.jpg'/>
                                <div>
                                    <p className='fw-bold primary-fg mb-0'>John Smith</p>
            ...
            <div className='container'>
                <div className='row mb-5'>
                    <div className='col-md-8 col-xl-6 text-center mx-auto'>
                        ...
                        <h2 className='fw-bold primary-fg'>How you can reach us</h2>
                    </div>
                </div>
                    ...
                    <div className='col-md-6 col-xl-4'>
                        <div>
                            <form className='p-3 p-xl-4' method='post'>
                                ...
                                <div className='mb-3'>
                                    <input className='form-control' type='email' id='email-1' name='email'
                                           placeholder='Email'/>
                                </div>
                                <div className='mb-3'>
                                ...
                                <div>
                                    <button className='btn buttons d-block w-100' type='submit'>
                                        Send
                                    </button>
                                </div>
                            </form>
                        ...
                        <div
                            ...
                            <div className='d-flex align-items-center p-3'>
                                <div
                                    ...
                                    <svg xmlns='http://www.w3.org/2000/svg' width='1em' height='1em'
                                         fill='currentColor' viewBox='0 0 16 16' className='bi bi-telephone'>
                                        <path
                            ...
                            <div className='d-flex align-items-center p-3'>
                                <div
                                    className='bs-icon-md bs-icon-circle bs-icon-primary d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block bs-icon bs-icon-md'>
                                    <svg xmlns='http://www.w3.org/2000/svg' width='1em' height='1em'
                                         fill='currentColor' viewBox='0 0 16 16' className='bi bi-envelope'>
                            ...
                            <div className='d-flex align-items-center p-3'>
                                <div
                                    className='bs-icon-md bs-icon-circle bs-icon-primary d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block bs-icon bs-icon-md'>
                                    <svg xmlns='http://www.w3.org/2000/svg' width='1em' height='1em'
                                         fill='currentColor' viewBox='0 0 16 16' className='bi bi-pin'>
                                        <path
            ...
            <div className='container'>
                <div
                    ...
                    <div className='text-center text-lg-start py-3 py-lg-1'>
                        <h2 className='fw-bold mb-2 primary-fg'>Subscribe to our newsletter</h2>
                    ...
                    <form className='d-flex justify-content-center flex-wrap flex-lg-nowrap' method='post'>
                        <div className='my-2'>
                            <input className='border rounded-pill -sm form-control' type='email' name='email'
