              ...
              <div className='card-body p-4'>
                <div className='d-flex justify-content-between'>
                  <div>
                    ...
                    <p>Suscipit</p>
                    <h4 className='display-4 fw-bold'>$25</h4>
                  </div>
                </div>
                <div>
                  <ul className='list-unstyled'>
                    <li className='d-flex mb-2'>
                      <span className='bs-icon-xs bs-icon-rounded bs-icon-primary-light bs-icon bs-icon-xs me-2'>
                        <svg xmlns='http://www.w3.org/2000/svg' width='1em' height='1em' fill='currentColor' viewBox='0 0 16 16' className='bi bi-check-lg text-primary'>
              ...
              <div className='card-body p-4'>
                <div className='d-flex justify-content-between'>
                  <div>
                    ...
                    <p>Suscipit + donec</p>
                    <h4 className='display-4 fw-bold text-white'>$38</h4>
                  </div>
                  <div>
                    <span className='badge rounded-pill bg-primary text-uppercase bg-semi-white'>Best Value</span>
                  </div>
                </div>
                <div>
                  <ul className='list-unstyled'>
                ...
                <button className='btn btn-primary d-block w-100 bg-semi-white' type='button'>
                  Button
                </button>
              </div>
            </div>
