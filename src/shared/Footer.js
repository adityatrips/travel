    ...
    return (
        <footer className='bg-dark'>
            <div className='container py-4 py-lg-5'>
                <div
                    className='col-lg-3 text-center text-lg-start d-flex flex-column align-items-center order-first align-items-lg-start order-lg-last'>
                    <div className='fw-bold d-flex align-items-center mb-2'>
            <span
                className='bs-icon-sm bs-icon-circle bs-icon-primary d-flex justify-content-center align-items-center bs-icon me-2'>
            ...
            <hr/>
            <div className='container text-muted d-flex justify-content-between align-items-center pt-3'>
